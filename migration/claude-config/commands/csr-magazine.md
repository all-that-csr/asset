...
### Figma 프레임 구조 (376x460)
```
프레임 "Vol.[호수] Thumbnail" (376x460, clipsContent: true)
├── Rectangle "Background Image" (376x460, IMAGE fill — Unsplash)
├── Rectangle "Gradient Overlay" (376x460, GRADIENT_LINEAR)
│   stops: 0→rgba(0,0,0,0.7), 0.3→rgba(0,0,0,0.4), 0.55→rgba(0,0,0,0.15), 0.8→rgba(0,0,0,0.5), 1→rgba(0,0,0,0.8)
├── Rectangle "Color Bar 1" (126x8, y:0, #0195df)
├── Rectangle "Color Bar 2" (125x8, y:0, #ffd200)
├── Rectangle "Color Bar 3" (126x8, y:0, #71c168)
├── Text "Headline Line 1" (x:23, y:55, 34px Black, #FFFFFF, drop-shadow)
├── Text "Headline Line 2" (x:23, y:아래, 34px Black, #ffd200, drop-shadow)
├── Rectangle "Sub Copy Bar" (3x42, x:23, #ffd200)
├── Text "Sub Copy" (x:36, 13px Medium, rgba(255,255,255,0.7))
├── Text "Masthead Title" (x:23, bottom:30px, 13px Black, #FFFFFF) — "ALL THAT CSR 매거진"
├── Text "Vol Number" (우측정렬, 11px Bold, rgba(255,255,255,0.7))
└── Text "Date" (우측정렬, 11px Medium, rgba(255,255,255,0.5))
```

### 폰트
- Noto Sans KR: Black, Bold, Medium 스타일 사용
